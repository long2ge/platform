 ...
 *
 *             @OA\Schema(
 *                 @OA\Property(property="data", type="object", description="评论ID",
 ...
 *                     @OA\Property(property="post_comments_praise_count", type="integer", description="获得点赞数"),
 *                     @OA\Property(property="astrict", type="integer", description="限制情况 0不限制，1屏蔽，2已删除"),
 *                     @OA\Property(property="created_at", type="string", description="发表时间"),
 *                     @OA\Property(property="visitor_user_praise", type="integer", description="访问者是否已点赞 0没1已"),
 *                 @OA\Property(property="reply_comment", type="object", description="上级评论",
 *                     @OA\Property(property="id", type="integer", description="上级评论id"),
 *                     @OA\Property(property="comment_content", type="string", description="上级评论内容"),
 *                     @OA\Property(property="astrict", type="integer", description="上级评论状态"),
 *                              ),
 *                 @OA\Property(property="post_user", type="object", description="上级评论用户信息",
 *                     @OA\Property(property="id", type="integer", description="上级评论用户id"),
 *                     @OA\Property(property="user_name", type="string", description="上级评论用户名字"),
 *                              ),
 *              example={"data":{"id":20,"post_id":10,"comment_user_id":10000009,"comment_content":"森的评论","type":1,"reply_comment_id":15,"reply_comment_user_id":10000009,"praise":0,"astrict":0,"created_at":"2020-06-01T15:19:35.000000Z","updated_at":"2020-06-01T15:19:35.000000Z","deleted_at":null,"post_comments_praise_count":1,"reply_comment":{"id":15,"comment_content":"评论已经删除","astrict":2,"comment_user_id":10000009,"comment_user_name":"用户1012623458"},"post_user":{"id":10000009,"user_name":"用户1012623458"},"visitor_user_praise":1}}
 *                            ),
 *                         ),
 *                      ),
 *                 ),
